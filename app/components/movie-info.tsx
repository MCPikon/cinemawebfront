...
export default function MovieInfo(
    ...
    return (
        <div style={{ backgroundImage: `url(${movie.backdrop})`, backgroundSize: "cover", backgroundRepeat: "no-repeat"}}>
            <div className="backdrop-blur-sm bg-black/60 p-6 md:px-9">
                ...
                <div className="md:flex md:gap-6">
                    <Image className="rounded-lg h-auto w-60 mx-auto mb-3 md:mb-0 md:w-80 md:self-start md:mx-0" src={movie.poster} alt={movie.title} width={616} height={924} />
                    <div>
                        <h1 className="text-3xl md:text-4xl font-bold">{movie.title}</h1>
                        <h2 className="text-xl mb-3 md:mb-0 md:text-2xl font-semibold">{movie.director}</h2>
                        <p>
                        ...
                        <p className="md:w-1/2 mt-1 text-base text-pretty font-light">{movie.overview}</p>
